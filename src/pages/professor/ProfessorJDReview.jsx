  ...
  return (
    <div className="bg-[#F8FAFC] text-[#1A2B4A] antialiased min-h-screen flex flex-col font-sans">
      ...
      <main className="max-w-5xl w-full mx-auto px-6 py-8 space-y-6 pb-20 flex-1">
          {/* REQUISITION CARD */}
          <div className="bg-white rounded-2xl p-7 border border-slate-200 shadow-sm animate-[fadeIn_0.3s_ease-out]">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden animate-[fadeIn_0.4s_ease-out]">
          ...
          {/* PROFESSOR FEEDBACK */}
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm animate-[fadeIn_0.5s_ease-out]">

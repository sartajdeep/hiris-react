...
export default function Header({ showSearch = false, portalLabel = 'Faculty Portal' }) {
      ...
      <div className="flex items-center gap-3">
        {showSearch && (
          <div className="hidden sm:flex relative w-56">
            ...
            <input
              className="w-full pl-9 pr-4 py-1.5 bg-[#F8FAFC] border border-[#E2E8F0] rounded-lg text-xs font-medium focus:ring-2 focus:ring-[#28666E]/20 focus:border-[#28666E] focus:bg-white outline-none transition-all"
              placeholder="Search..."
              type="text"
            />
          </div>
        ...
        <button className="relative p-2 text-[#94A3B8] hover:text-[#28666E] transition-colors rounded-lg focus:outline-none focus:ring-2 focus:ring-[#28666E]/20">
        ...
        {user && (
          <div className="flex items-center gap-2 pl-3 border-l border-[#E2E8F0]">
            ...
            <button
              ...
              title="Sign out"
              className="ml-1 p-1.5 text-[#94A3B8] hover:text-[#EF4444] transition-colors duration-150 rounded-lg"
            >

...
export default function ProfessorInterviewRoom() {
  ...
  if (phase === 'review') {
    return (
      <div className="bg-[color:var(--bg)] text-[#1A2B4A] min-h-screen flex flex-col font-sans">
        ...
        <main className="flex-1 max-w-7xl w-full mx-auto p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Left: AI Assessment */}
            <div className="bg-[color:var(--surface)] rounded-2xl border border-slate-200 shadow-sm p-6 animate-[fadeIn_0.3s_ease-out]">
            ...
            <div className="bg-[color:var(--surface)] rounded-2xl border border-slate-200 shadow-sm p-6 animate-[fadeIn_0.4s_ease-out]">
                <div className="flex items-center justify-between border-b border-slate-100 pb-4 mb-5">
                    <h2 className="text-sm font-bold text-[#0F1F3D] uppercase tracking-wider flex items-center gap-2">

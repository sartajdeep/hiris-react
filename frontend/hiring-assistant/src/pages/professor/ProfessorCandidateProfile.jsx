  ...
  return (
    <div className="bg-[#F4F6FA] text-[#1A2B4A] antialiased min-h-screen flex flex-col font-sans">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-6 py-6 flex flex-col gap-5 pb-16">
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 animate-[fadeIn_0.3s_ease-out]">
          ...
          <div className="flex flex-col lg:flex-row gap-5 flex-1 min-h-[600px]">
              ...
              <div className="w-full lg:w-[48%] bg-white rounded-2xl border border-slate-200 shadow-sm flex flex-col overflow-hidden animate-[fadeIn_0.4s_ease-out]">
                  ...
                  <div className="flex-1 bg-slate-100 overflow-y-auto custom-scrollbar p-6 flex justify-center">
                      <div className="w-full max-w-2xl bg-white shadow-xl min-h-[900px] p-10 flex flex-col gap-6 rounded-lg text-sm text-[#1A2B4A]">
                          {activeDoc === 'resume' && (
                            <>

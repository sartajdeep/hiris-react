      ...
      <main className="flex-1 flex flex-col max-w-7xl mx-auto w-full px-6 py-6 gap-5">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 bg-white p-5 rounded-xl shadow-card border border-[#E2E8F0] hover:shadow-md hover:-translate-y-px transition-all duration-150">
          <div className="flex flex-col justify-center">
            <div className="flex items-center gap-3">
              <h1 className="text-2xl font-bold font-heading text-[#0F172A]">{candidate.name}</h1>
            </div>
            <p className="text-[#475569] text-xs font-medium">{candidate.role_applied}</p>
        ...
        <div className="flex flex-col lg:flex-row gap-5 h-[calc(100vh-280px)] min-h-[600px]">
          <div className="flex-1 overflow-y-auto custom-scrollbar pr-2 flex flex-col gap-5">
            <section className="bg-white p-5 rounded-xl shadow-card border border-[#E2E8F0] hover:shadow-md hover:-translate-y-px transition-all duration-150">
            ...
            <section className="bg-white p-5 rounded-xl shadow-card border border-[#E2E8F0] hover:shadow-md hover:-translate-y-px transition-all duration-150">
              ...
              <div className="space-y-4">
                <div className="flex gap-4 p-4 rounded-lg bg-[#F8FAFC] border border-[#E2E8F0]">
                  ...
                  <div>
                    <h4 className="font-semibold text-sm text-[#0F172A] leading-tight mb-1">Stanford University</h4>
                    <p className="text-xs text-[#28666E] font-bold">Master of Education (M.Ed.)</p>
                    <p className="text-[11px] text-[#475569] font-medium mt-1">Higher Education Administration • Class of 2018</p>
                  </div>
                </div>
              </div>
            </section>

            <section className="bg-white p-5 rounded-xl shadow-card border border-[#E2E8F0] mb-6 hover:shadow-md hover:-translate-y-px transition-all duration-150">
              <div className="flex items-center gap-2 mb-6 text-[#28666E]">
                <span className="material-symbols-outlined text-[20px]">quiz</span>
                <h3 className="text-sm font-semibold text-[#0F172A]">Additional Questions</h3>
              </div>
              <div className="space-y-6">
                <div>
                  <h4 className="text-xs font-bold text-[#0F172A] mb-2 italic">"Why are you interested in this role at Your Organization?"</h4>
                  <div className="p-4 rounded-lg bg-[#F8FAFC] border-l-4 border-primary text-[#475569] text-xs font-medium leading-relaxed">
                ...
                <div>
                  <h4 className="text-xs font-bold text-[#0F172A] mb-2 italic">"Describe a time you handled a difficult situation with a student or parent."</h4>
                  <div className="p-4 rounded-lg bg-[#F8FAFC] border-l-4 border-primary text-[#475569] text-xs font-medium leading-relaxed">
            ...
            <section className="bg-[#F8FAFC] p-5 rounded-xl shadow-sm border border-[#28666E]/20 mb-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  <div className="bg-white p-3 rounded-lg border border-[#E2E8F0]">
                    <p className="text-[10px] text-[#475569] font-bold uppercase mb-1.5">Communication</p>
                    <div className="w-full bg-[#E2E8F0] rounded-full h-1"><div className="bg-[#28666E] h-1 rounded-full" style={{width:'90%'}}></div></div>
                  </div>
                  <div className="bg-white p-3 rounded-lg border border-[#E2E8F0]">
                    <p className="text-[10px] text-[#475569] font-bold uppercase mb-1.5">Situational Judgment</p>
          ...
          <div className="flex-1 h-full flex flex-col bg-white rounded-xl shadow-card border border-[#E2E8F0] overflow-hidden hover:shadow-md hover:-translate-y-px transition-all duration-150">
            <div className="px-5 border-b border-[#E2E8F0] flex items-center justify-between bg-[#F1F5F9] pt-2">
            ...
            <div className="flex-1 bg-[#F1F5F9] overflow-y-auto p-5 flex justify-center custom-scrollbar">
              <div className="w-full max-w-2xl bg-white shadow-xl min-h-[800px] p-12 flex flex-col gap-5 border border-[#E2E8F0]">
                {activeTab === 'resume' && (
                  <>
                    <div className="flex flex-col items-center gap-2 text-center border-b border-[#E2E8F0] pb-8">
                      <h1 className="text-2xl font-bold font-heading text-[#0F172A] uppercase tracking-wider">{candidate.name}</h1>
                      <p className="text-xs font-semibold text-[#475569]">{candidate.location} • {candidate.phone}</p>
                    </div>
                    <div className="flex flex-col gap-4 mt-4">
                      <h2 className="text-xs font-bold text-[#0F172A] border-b-2 border-[#0F172A] pb-1 w-fit uppercase tracking-wider">Professional Summary</h2>
                      <p className="text-xs font-medium text-[#475569] leading-relaxed">Dedicated Higher Education Professional with over 7 years of experience in admissions.</p>
                    </div>
                  </>
                )}
                ...
                {activeTab === 'cv' && (
                  <>
                    <div className="flex flex-col items-center gap-2 text-center border-b border-[#E2E8F0] pb-8">
                      <h1 className="text-2xl font-bold font-heading text-[#0F172A] uppercase tracking-wider">Curriculum Vitae</h1>
                    </div>
                    <div className="flex flex-col gap-4 mt-4 text-xs">
                      <h2 className="font-bold text-[#0F172A] border-b-2 border-[#0F172A] pb-1 w-fit uppercase tracking-wider">Academic History</h2>
                      <p className="text-[#475569] font-medium leading-relaxed">Detailed research and education history.</p>
                    </div>
                  </>
                )}
                ...
                {activeTab === 'chat' && (
                  <div>
                    <h2 className="text-sm font-bold text-[#0F172A] mb-6">AI Interview Chat Transcript</h2>
                    <div className="space-y-4">
                      <div className="flex gap-4">
                        ...
                        <div className="bg-[#F8FAFC] p-3 rounded-lg border border-[#E2E8F0] text-xs font-medium text-[#334155]">Hello James, could you tell me about your experience dealing with difficult cases in admissions?</div>
                      </div>
                      <div className="flex gap-4 flex-row-reverse">
                        ...
                        <div className="bg-white p-3 rounded-lg border border-[#E2E8F0] text-xs font-medium text-[#334155]">Certainly. I typically approach cases with a de-escalation framework and try to prioritize empathy...</div>
                      </div>
                    </div>
                  </div>
                )}

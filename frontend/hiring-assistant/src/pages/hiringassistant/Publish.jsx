      ...
      <main className="flex-grow flex items-center justify-center px-8 py-10 bg-[#F8FAFC]">
        <div className="w-full max-w-3xl bg-white rounded-xl shadow-md border border-[#E2E8F0] overflow-hidden">
          <div className="bg-[#F8FAFC] border-b border-[#E2E8F0] p-6 relative overflow-hidden flex items-center gap-4 isolate">
            ...
            <div className="w-12 h-12 bg-white rounded-xl shadow-sm border border-[#E2E8F0] flex items-center justify-center text-[#28666E] shrink-0">
              <span className="material-symbols-outlined text-[24px]">rocket_launch</span>
            </div>
            <div>
              <h1 className="text-2xl font-bold text-[#0F172A] font-heading leading-tight">Publish &amp; Distribute</h1>
              <p className="text-xs font-medium text-[#475569] mt-1 max-w-md">Finalize your job posting and sync it across university integration channels.</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="p-6 border-r border-[#E2E8F0]">
              ...
              <div className="space-y-1">
                {[
                  ...
                  { id: 'email', name: 'Internal Email List', defaultChecked: false, icon: <span className="material-symbols-outlined text-[14px]">mail</span>, iconColor: 'text-[#475569]' },
                ].map(channel => (
                  <div key={channel.id} className="flex items-center justify-between p-3 rounded-lg hover:bg-[#F8FAFC] transition-colors duration-150 cursor-default group">
                    <div className="flex items-center gap-3">
                      <div className={`w-6 h-6 rounded bg-[#F8FAFC] flex items-center justify-center border border-[#E2E8F0] shadow-sm ${channel.iconColor}`}>
                        {channel.icon}
                      </div>
                      <div>
                        <p className="text-[13px] font-semibold text-[#0F172A]">{channel.name}</p>
                      </div>
                    </div>
            ...
            <div className="p-6 bg-white">
              ...
              <p className="text-xs font-medium text-[#475569] mb-4">Use this direct reference link in customized communications.</p>
              
              <div className="space-y-4">
                <div className="relative flex items-center">
                  <input readOnly className="w-full rounded-lg border border-[#E2E8F0] bg-[#F8FAFC] px-3 py-2 pr-9 text-[13px] font-medium text-[#0F172A] focus:border-[#28666E] focus:ring-0 focus:shadow-[0_0_0_3px_rgba(40,102,110,0.1)] focus:bg-white outline-none transition-all duration-150" type="text" value={linkValue}/>
          ...
          <div className="p-6 border-t border-[#E2E8F0] bg-[#F8FAFC] flex flex-col items-center">

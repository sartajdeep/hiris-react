        ...
        <form className="space-y-8" onSubmit={handleSubmit}>
          ...
          <section className="rounded-xl bg-white p-5 shadow-[0_1px_3px_rgba(0,0,0,0.06)] ring-1 ring-[#28666E]/20 transition-all duration-150 sm:p-5">
            <div className="mb-6 flex items-center gap-3">
              ...
              <h3 className="text-xl font-bold text-[#0F172A]">1. Personal Information</h3>
            </div>
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
              <div className="space-y-2">
                <label className="text-sm font-semibold text-[#334155]">Full Name</label>
                <input required type="text" value={formData.name} onChange={e => handleInputChange('name', e.target.value)} className="w-full rounded-lg border-[#E2E8F0] bg-[#F8FAFC] p-3 text-[#0F172A] focus:border-[#28666E] focus:ring-[#28666E]/20 transition-all duration-150" placeholder="John Doe" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-semibold text-[#334155]">Email Address</label>
                <input required type="email" value={formData.email} onChange={e => handleInputChange('email', e.target.value)} className="w-full rounded-lg border-[#E2E8F0] bg-[#F8FAFC] p-3 text-[#0F172A] focus:border-[#28666E] focus:ring-[#28666E]/20 transition-all duration-150" placeholder="john@example.com" />
              </div>
            </div>
          </section>
          ...
          <section className="rounded-xl bg-white p-5 shadow-[0_1px_3px_rgba(0,0,0,0.06)] ring-1 ring-[#28666E]/20 transition-all duration-150 sm:p-5">
            <div className="mb-6 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl font-bold text-[#0F172A]">2. Academic Background</h3>
              </div>
            ...
            <div className="space-y-8">
              {formData.degrees.map((degree, index) => (
                <div key={degree.id} className="degree-entry grid grid-cols-1 gap-5 sm:grid-cols-2 pb-6 border-b border-[#E2E8F0] last:border-0 last:pb-0 pt-0 mt-0 first:pt-0 border-t-0 p-[unset] border-slate-100">
          ...
          <section className="rounded-xl bg-white p-5 shadow-[0_1px_3px_rgba(0,0,0,0.06)] ring-1 ring-[#28666E]/20 transition-all duration-150 sm:p-5">
            <div className="mb-6 flex items-center gap-3">
              ...
              <h3 className="text-xl font-bold text-[#0F172A]">3. Documents</h3>
            </div>
          ...
          <section className="rounded-xl bg-white p-5 shadow-[0_1px_3px_rgba(0,0,0,0.06)] ring-1 ring-[#28666E]/20 transition-all duration-150 sm:p-5">
            <div className="mb-6 flex items-center gap-3">
              ...
              <h3 className="text-xl font-bold text-[#0F172A]">4. Professional Links</h3>
            </div>
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
              <div className="space-y-2">
          ...
          <section className="rounded-xl bg-white p-5 shadow-[0_1px_3px_rgba(0,0,0,0.06)] ring-1 ring-[#28666E]/20 transition-all duration-150 sm:p-5">
            <div className="mb-6 flex items-center gap-3">
              ...
              <h3 className="text-xl font-bold text-[#0F172A]">5. Additional Questions</h3>
            </div>
            <div className="space-y-6">
              <div className="space-y-2">

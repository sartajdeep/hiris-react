      ...
      <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8 w-full flex-1">
        ...
        <div className="mb-12 flex items-center justify-between">
          <div className="flex flex-col items-center relative z-10 w-12">
            <div className={`flex h-12 w-12 items-center justify-center rounded-full font-bold text-lg shadow-[0_1px_3px_rgba(0,0,0,0.06)] transition-colors duration-300 ${currentStep >= 1 ? 'bg-[#28666E] text-white' : 'bg-slate-200 text-[color:var(--text-secondary)]'}`}>1</div>
            <span className={`absolute top-14 mt-2 text-sm whitespace-nowrap transition-colors duration-300 ${currentStep >= 1 ? 'font-bold text-[#28666E]' : 'font-medium text-[color:var(--text-secondary)]'}`}>Upload Documents</span>
          </div>
          ...
          <div className="flex flex-col items-center relative z-10 w-12">
            <div className={`flex h-12 w-12 items-center justify-center rounded-full font-bold text-lg shadow-[0_1px_3px_rgba(0,0,0,0.06)] transition-colors duration-300 ${currentStep >= 2 ? 'bg-[#28666E] text-white' : 'bg-slate-200 text-[color:var(--text-secondary)]'}`}>2</div>
            <span className={`absolute top-14 mt-2 text-sm text-center whitespace-nowrap transition-colors duration-300 ${currentStep >= 2 ? 'font-bold text-[#28666E]' : 'font-medium text-[color:var(--text-secondary)]'}`}>Candidate Details</span>
          </div>
          <div className="h-1 flex-1 bg-slate-200 mx-4 rounded relative z-0 -mt-8">
            <div className="h-1 bg-[#28666E] rounded transition-all duration-500" style={{ width: currentStep >= 3 ? '100%' : '0%' }}></div>
          </div>
          <div className="flex flex-col items-center relative z-10 w-12">
            <div className={`flex h-12 w-12 items-center justify-center rounded-full font-bold text-lg shadow-[0_1px_3px_rgba(0,0,0,0.06)] transition-colors duration-300 ${currentStep >= 3 ? 'bg-[#28666E] text-white' : 'bg-slate-200 text-[color:var(--text-secondary)]'}`}>3</div>
            <span className={`absolute top-14 mt-2 text-sm whitespace-nowrap transition-colors duration-300 ${currentStep >= 3 ? 'font-bold text-[#28666E]' : 'font-medium text-[color:var(--text-secondary)]'}`}>AI Chat</span>
          </div>
        </div>
            ...
            <div className="space-y-8 animate-in fade-in duration-300">
              <section className="rounded-xl bg-[color:var(--surface)] p-5 shadow-[0_1px_3px_rgba(0,0,0,0.06)] ring-1 ring-[#28666E]/20 transition-all duration-150 sm:p-5">
                <div className="mb-6 flex items-center gap-3">
                  ...
                  <h3 className="text-xl font-bold text-[color:var(--text-primary)]">Documents</h3>
                </div>
            ...
            <div className="space-y-8 animate-in fade-in duration-300">
              <section className="rounded-xl bg-[color:var(--surface)] p-5 shadow-[0_1px_3px_rgba(0,0,0,0.06)] ring-1 ring-[#28666E]/20 transition-all duration-150 sm:p-5">
                <div className="mb-6 flex items-center gap-3">
                  ...
                  <h3 className="text-xl font-bold text-[color:var(--text-primary)]">Personal Information</h3>
                </div>
                <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-[color:var(--text-secondary)]">Full Name</label>
                    <input type="text" value={formData.name} onChange={e => handleInputChange('name', e.target.value)} className="w-full rounded-lg border-[color:var(--border)] bg-[color:var(--bg)] p-3 text-[color:var(--text-primary)] focus:border-[#28666E] focus:ring-[#28666E]/20 transition-all duration-150" placeholder="John Doe" required />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-[color:var(--text-secondary)]">Email Address</label>
                    <input type="email" value={formData.email} onChange={e => handleInputChange('email', e.target.value)} className="w-full rounded-lg border-[color:var(--border)] bg-[color:var(--bg)] p-3 text-[color:var(--text-primary)] focus:border-[#28666E] focus:ring-[#28666E]/20 transition-all duration-150" placeholder="john@example.com" required />
                  </div>
                </div>
              </section>
              ...
              <section className="rounded-xl bg-[color:var(--surface)] p-5 shadow-[0_1px_3px_rgba(0,0,0,0.06)] ring-1 ring-[#28666E]/20 transition-all duration-150 sm:p-5">
                <div className="mb-6 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-xl font-bold text-[color:var(--text-primary)]">Academic Background</h3>
                  </div>
                ...
                <div className="space-y-8">
                  {formData.degrees.map((degree) => (
                    <div key={degree.id} className="degree-entry grid grid-cols-1 gap-5 sm:grid-cols-2 pb-6 border-b border-[color:var(--border)] last:border-0 last:pb-0 pt-0 mt-0 first:pt-0 border-t-0 border-slate-100 p-[unset]">
              ...
              <section className="rounded-xl bg-[color:var(--surface)] p-5 shadow-[0_1px_3px_rgba(0,0,0,0.06)] ring-1 ring-[#28666E]/20 transition-all duration-150 sm:p-5">
                <div className="mb-6 flex items-center gap-3">
                  ...
                  <h3 className="text-xl font-bold text-[color:var(--text-primary)]">Professional Links</h3>
                </div>
                <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                  <div className="space-y-2">
              ...
              <section className="rounded-xl bg-[color:var(--surface)] p-5 shadow-[0_1px_3px_rgba(0,0,0,0.06)] ring-1 ring-[#28666E]/20 transition-all duration-150 sm:p-5">
                <div className="mb-6 flex items-center gap-3">
                  ...
                  <h3 className="text-xl font-bold text-[color:var(--text-primary)]">Additional Questions</h3>
                </div>
                <div className="space-y-6">
                  <div className="space-y-2">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-center gap-4 rounded-xl border border-[#28666E]/20 bg-[#28666E]/5 p-5">
                <button type="button" onClick={() => goToStep(1)} className="w-full sm:w-auto rounded-xl bg-slate-200 px-8 py-3 font-bold text-[color:var(--text-secondary)] hover:bg-slate-300 transition-all">
                  Back
                </button>
                <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
                  <span className="text-sm text-[color:var(--text-secondary)] italic text-center">AI has extracted details from your resume. Review and proceed.</span>
            ...
            <div className="space-y-8 animate-in fade-in duration-300">
              <section className="rounded-xl bg-[color:var(--surface)] p-5 shadow-[0_1px_3px_rgba(0,0,0,0.06)] ring-1 ring-[#28666E]/20 transition-all duration-150 sm:p-5">
                <div className="mb-6 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-xl font-bold text-[color:var(--text-primary)]">AI Assistant Chat</h3>
                  </div>
                </div>
                <div className="text-center mb-6">
                  <p className="text-sm text-[color:var(--text-secondary)]">Answer a few custom questions based on your resume and the role requirements.</p>
                </div>

                <div className="flex flex-col h-[400px] overflow-hidden rounded-xl border border-[color:var(--border)] bg-[color:var(--bg)]">
              ...
              <div className="flex flex-col items-center justify-between gap-4 rounded-xl border border-[#28666E]/20 bg-[#28666E]/5 p-5 sm:flex-row">
                <div className="flex flex-col sm:flex-row gap-4 items-center w-full sm:w-auto">
                  <button type="button" onClick={() => goToStep(2)} className="w-full sm:w-auto rounded-xl bg-slate-200 px-8 py-3 font-bold text-[color:var(--text-secondary)] hover:bg-slate-300 transition-all">
                    Back
                  </button>
                  <div className="flex items-start gap-3 w-full sm:w-auto mt-4 sm:mt-0">
                    <input type="checkbox" id="terms" checked={formData.termsAccepted} onChange={e => handleInputChange('termsAccepted', e.target.checked)} className="mt-1 rounded border-[color:var(--border)] text-[#28666E] focus:ring-[#28666E]/20 transition-all duration-150" required />

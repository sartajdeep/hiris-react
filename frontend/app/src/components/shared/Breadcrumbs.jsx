...
export default function Breadcrumbs() {
  ...
  return (
    <div className="flex items-center gap-2 px-6 py-3 bg-[var(--bg)] border-b border-[var(--border)] text-[12px] font-medium text-[var(--text-muted)]">
      <Link to="/" className="hover:text-[var(--teal)] transition-colors flex items-center gap-1">
        ...
        return (
          <div key={to} className="flex items-center gap-2">
            ...
            {isLast ? (
              ...
              <Link to={to} className="hover:text-[var(--teal)] transition-colors">
                {title}
              </Link>
            )}
          </div>

...
export default function TopNav() {
  ...
  return (
    <div className="bg-[var(--surface)] border-b border-[var(--border)] px-6 flex items-center overflow-x-auto custom-scrollbar flex-shrink-0">
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-2 px-3 py-2 rounded-lg text-[13px] transition-colors whitespace-nowrap ${
                active 
                  ? 'bg-[rgba(40,102,110,0.1)] text-[var(--teal)] font-bold' 
                  : 'text-[var(--text-primary)] hover:bg-[var(--bg)] font-medium'
              }`}
            >

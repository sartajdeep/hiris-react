    ...
    <div className="bg-[var(--bg)] text-[var(--text-primary)] antialiased min-h-screen flex flex-col font-sans">
      ...
      <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8 flex flex-col items-center flex-grow">
        ...
        <div className="text-center mb-10">
          <h1 className="text-[var(--text-primary)] text-2xl font-bold md:text-5xl font-heading leading-tight tracking-tight mb-4">Thank You for Applying!</h1>
        ...
        <div className="w-full bg-[var(--surface)] p-5 mb-12 shadow-sm ring-1 ring-[#28666E]/20 rounded-xl text-center">
          <p className="text-[var(--text-muted)] text-sm font-semibold uppercase tracking-wider mb-2">Application Token Number</p>
        ...
        <div className="w-full mb-12">
          <h2 className="text-[var(--text-primary)] text-2xl font-bold mb-6 flex items-center gap-2 font-heading">
            <span className="material-symbols-outlined text-[#28666E] text-[24px]">list_alt</span>
            What happens next?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            <div className="flex flex-col gap-3 p-5 rounded-xl bg-[var(--surface)] ring-1 ring-[#28666E]/20 shadow-sm">
              <span className="text-[#28666E] font-bold text-lg font-heading">01.</span>
              <h3 className="font-semibold text-sm text-[var(--text-primary)]">Initial Review</h3>
              <p className="text-xs font-medium text-[var(--text-muted)]">Our HR team will review your credentials against the program requirements.</p>
            </div>
            <div className="flex flex-col gap-3 p-5 rounded-xl bg-[var(--surface)] ring-1 ring-[#28666E]/20 shadow-sm">
              <span className="text-[#28666E] font-bold text-lg font-heading">02.</span>
              <h3 className="font-semibold text-sm text-[var(--text-primary)]">Shortlisting</h3>
              <p className="text-xs font-medium text-[var(--text-muted)]">Shortlisted candidates will be contacted via email within 2-3 weeks.</p>
            </div>
            <div className="flex flex-col gap-3 p-5 rounded-xl bg-[var(--surface)] ring-1 ring-[#28666E]/20 shadow-sm">
              <span className="text-[#28666E] font-bold text-lg font-heading">03.</span>
              <h3 className="font-semibold text-sm text-[var(--text-primary)]">Interview</h3>
              <p className="text-xs font-medium text-[var(--text-muted)]">Initial rounds of technical and cultural interviews will be scheduled.</p>
            </div>
          </div>
        </div>
      </main>

  ...
  return (
    <div className="bg-[var(--bg)] text-[var(--text-primary)] antialiased min-h-screen flex flex-col font-sans">
      ...
      <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8 w-full flex-1">
        <div className="mb-12">
          <h2 className="text-2xl font-extrabold tracking-tight text-[var(--text-primary)] sm:text-5xl">{programData.roleTitle}</h2>
          <p className="mt-4 text-lg text-[var(--text-muted)]">{programData.roleDescription}</p>
        </div>

        {/* Stepper UI */}
        <div className="mb-12 flex items-center justify-between">
          <div className="flex flex-col items-center relative z-10 w-12">
            <div className={`flex h-12 w-12 items-center justify-center rounded-full font-bold text-lg shadow-[0_1px_3px_rgba(0,0,0,0.06)] transition-colors duration-300 ${currentStep >= 1 ? 'bg-[#28666E] text-white' : 'bg-slate-200 text-[var(--text-muted)]'}`}>1</div>
            <span className={`absolute top-14 mt-2 text-sm whitespace-nowrap transition-colors duration-300 ${currentStep >= 1 ? 'font-bold text-[#28666E]' : 'font-medium text-[var(--text-muted)]'}`}>Upload Documents</span>
          </div>
          ...
          <div className="flex flex-col items-center relative z-10 w-12">
            <div className={`flex h-12 w-12 items-center justify-center rounded-full font-bold text-lg shadow-[0_1px_3px_rgba(0,0,0,0.06)] transition-colors duration-300 ${currentStep >= 2 ? 'bg-[#28666E] text-white' : 'bg-slate-200 text-[var(--text-muted)]'}`}>2</div>
            <span className={`absolute top-14 mt-2 text-sm text-center whitespace-nowrap transition-colors duration-300 ${currentStep >= 2 ? 'font-bold text-[#28666E]' : 'font-medium text-[var(--text-muted)]'}`}>Candidate Details</span>
          </div>
          <div className="h-1 flex-1 bg-slate-200 mx-4 rounded relative z-0 -mt-8">
            <div className="h-1 bg-[#28666E] rounded transition-all duration-500" style={{ width: currentStep >= 3 ? '100%' : '0%' }}></div>
          </div>
          <div className="flex flex-col items-center relative z-10 w-12">
            <div className={`flex h-12 w-12 items-center justify-center rounded-full font-bold text-lg shadow-[0_1px_3px_rgba(0,0,0,0.06)] transition-colors duration-300 ${currentStep >= 3 ? 'bg-[#28666E] text-white' : 'bg-slate-200 text-[var(--text-muted)]'}`}>3</div>
            <span className={`absolute top-14 mt-2 text-sm whitespace-nowrap transition-colors duration-300 ${currentStep >= 3 ? 'font-bold text-[#28666E]' : 'font-medium text-[var(--text-muted)]'}`}>AI Chat</span>
          </div>
        </div>
        ...
        <form className="space-y-8" onSubmit={handleSubmit}>
          ...
          {currentStep === 1 && (
            <div className="space-y-8 animate-in fade-in duration-300">
              <section className="rounded-xl bg-[var(--surface)] p-5 shadow-[0_1px_3px_rgba(0,0,0,0.06)] ring-1 ring-[#28666E]/20 transition-all duration-150 sm:p-5">
                <div className="mb-6 flex items-center gap-3">
                  <span className="material-symbols-outlined text-[#28666E]">description</span>
                  <h3 className="text-xl font-bold text-[var(--text-primary)]">Documents</h3>
                </div>
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <p className={`mt-2 text-sm ${files.resume.name ? 'text-[#28666E] font-bold' : 'text-[var(--text-muted)]'}`}>
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <p className={`mt-2 text-sm ${files.cv.name ? 'text-[#28666E] font-bold' : 'text-[var(--text-muted)]'}`}>
            ...
            <div className="space-y-8 animate-in fade-in duration-300">
              <section className="rounded-xl bg-[var(--surface)] p-5 shadow-[0_1px_3px_rgba(0,0,0,0.06)] ring-1 ring-[#28666E]/20 transition-all duration-150 sm:p-5">
                ...
                <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <input type="text" value={formData.name} onChange={e => handleInputChange('name', e.target.value)} className="w-full rounded-lg border-[var(--border)] bg-[var(--bg)] p-3 text-[var(--text-primary)] focus:border-[#28666E] focus:ring-[#28666E]/20 transition-all duration-150" placeholder="John Doe" required />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-[#334155]">Email Address</label>
                    <input type="email" value={formData.email} onChange={e => handleInputChange('email', e.target.value)} className="w-full rounded-lg border-[var(--border)] bg-[var(--bg)] p-3 text-[var(--text-primary)] focus:border-[#28666E] focus:ring-[#28666E]/20 transition-all duration-150" placeholder="john@example.com" required />
                  </div>
                </div>
              </section>
              ...
              <section className="rounded-xl bg-[var(--surface)] p-5 shadow-[0_1px_3px_rgba(0,0,0,0.06)] ring-1 ring-[#28666E]/20 transition-all duration-150 sm:p-5">
                <div className="mb-6 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-xl font-bold text-[var(--text-primary)]">Academic Background</h3>
                  </div>
                ...
                <div className="space-y-8">
                  {formData.degrees.map((degree) => (
                    <div key={degree.id} className="degree-entry grid grid-cols-1 gap-5 sm:grid-cols-2 pb-6 border-b border-[var(--border)] last:border-0 last:pb-0 pt-0 mt-0 first:pt-0 border-t-0 border-slate-100 p-[unset]">
                      <div className="sm:col-span-2 space-y-2">
                        <label className="text-sm font-semibold text-[#334155]">University / College</label>
                        <input type="text" value={degree.college} onChange={e => handleDegreeChange(degree.id, 'college', e.target.value)} className="w-full rounded-lg border-[var(--border)] bg-[var(--bg)] p-3 text-[var(--text-primary)] focus:border-[#28666E] focus:ring-[#28666E]/20 transition-all duration-150" />
                      </div>
                      <div className="space-y-2">
                        <label className="text-sm font-semibold text-[#334155]">Degree</label>
                        <input type="text" value={degree.degree} onChange={e => handleDegreeChange(degree.id, 'degree', e.target.value)} className="w-full rounded-lg border-[var(--border)] bg-[var(--bg)] p-3 text-[var(--text-primary)] focus:border-[#28666E] focus:ring-[#28666E]/20 transition-all duration-150" placeholder="e.g. Bachelor of Technology" />
                      </div>
                      <div className="space-y-2">
                        <label className="text-sm font-semibold text-[#334155]">Major / Program</label>
                        <input type="text" value={degree.major} onChange={e => handleDegreeChange(degree.id, 'major', e.target.value)} className="w-full rounded-lg border-[var(--border)] bg-[var(--bg)] p-3 text-[var(--text-primary)] focus:border-[#28666E] focus:ring-[#28666E]/20 transition-all duration-150" placeholder="Computer Science" />
                      </div>
                      <div className="space-y-2">
                        <label className="text-sm font-semibold text-[#334155]">Year of Completion</label>
                        <input type="number" value={degree.year} onChange={e => handleDegreeChange(degree.id, 'year', e.target.value)} className="w-full rounded-lg border-[var(--border)] bg-[var(--bg)] p-3 text-[var(--text-primary)] focus:border-[#28666E] focus:ring-[#28666E]/20 transition-all duration-150" placeholder="2024" />
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <section className="rounded-xl bg-[var(--surface)] p-5 shadow-[0_1px_3px_rgba(0,0,0,0.06)] ring-1 ring-[#28666E]/20 transition-all duration-150 sm:p-5">
                <div className="mb-6 flex items-center gap-3">
                  ...
                  <h3 className="text-xl font-bold text-[var(--text-primary)]">Professional Links</h3>
                </div>
                <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input type="url" value={formData.linkedIn} onChange={e => handleInputChange('linkedIn', e.target.value)} className="w-full rounded-lg border-[var(--border)] bg-[var(--bg)] py-3 pl-10 pr-3 text-[var(--text-primary)] focus:border-[#28666E] focus:ring-[#28666E]/20 transition-all duration-150" placeholder="linkedin.com/in/username" />
                    </div>
                  </div>
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input type="url" value={formData.github} onChange={e => handleInputChange('github', e.target.value)} className="w-full rounded-lg border-[var(--border)] bg-[var(--bg)] py-3 pl-10 pr-3 text-[var(--text-primary)] focus:border-[#28666E] focus:ring-[#28666E]/20 transition-all duration-150" placeholder="github.com/username" />
                    </div>
                  </div>
                </div>
              </section>
              ...
              <section className="rounded-xl bg-[var(--surface)] p-5 shadow-[0_1px_3px_rgba(0,0,0,0.06)] ring-1 ring-[#28666E]/20 transition-all duration-150 sm:p-5">
                <div className="mb-6 flex items-center gap-3">
                  ...
                  <h3 className="text-xl font-bold text-[var(--text-primary)]">Additional Questions</h3>
                </div>
                <div className="space-y-6">
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-[#334155]">Why are you interested in AI Ethics research?</label>
                    <textarea rows="4" value={formData.motivation} onChange={e => handleInputChange('motivation', e.target.value)} className="w-full rounded-lg border-[var(--border)] bg-[var(--bg)] p-3 text-[var(--text-primary)] focus:border-[#28666E] focus:ring-[#28666E]/20 transition-all duration-150" placeholder="Share your perspective..."></textarea>
                  </div>
                </div>
              </section>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-center gap-4 rounded-xl border border-[#28666E]/20 bg-[#28666E]/5 p-5">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
                  <span className="text-sm text-[var(--text-muted)] italic text-center">AI has extracted details from your resume. Review and proceed.</span>
              ...
              <section className="rounded-xl bg-[var(--surface)] p-5 shadow-[0_1px_3px_rgba(0,0,0,0.06)] ring-1 ring-[#28666E]/20 transition-all duration-150 sm:p-5">
                <div className="mb-6 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-xl font-bold text-[var(--text-primary)]">AI Assistant Chat</h3>
                  </div>
                </div>
                <div className="text-center mb-6">
                  <p className="text-sm text-[var(--text-muted)]">Answer a few custom questions based on your resume and the role requirements.</p>
                </div>

                <div className="flex flex-col h-[400px] overflow-hidden rounded-xl border border-[var(--border)] bg-[var(--bg)]">
                  ...
                  <div className="border-t border-[var(--border)] px-4 py-4 bg-[var(--surface)]">
                    <div className="flex items-start gap-3">
                      <textarea 
                        ...
                        className="flex-1 resize-none rounded-xl border border-[var(--border)] bg-[var(--surface)] px-4 py-3 text-sm text-[var(--text-primary)] focus:ring-[#28666E]/20 transition-all duration-150 focus:border-[#28666E] hover:shadow-[0_4px_12px_rgba(0,0,0,0.08)] hover:-translate-y-px" 
              ...
              <div className="flex flex-col items-center justify-between gap-4 rounded-xl border border-[#28666E]/20 bg-[#28666E]/5 p-5 sm:flex-row">
                <div className="flex flex-col sm:flex-row gap-4 items-center w-full sm:w-auto">
                  ...
                  <div className="flex items-start gap-3 w-full sm:w-auto mt-4 sm:mt-0">
                    ...
                    <label htmlFor="terms" className="text-sm text-[var(--text-muted)]">I certify that the information provided is accurate and complete.</label>
                  </div>
                </div>
                <button 
                  type="submit" 

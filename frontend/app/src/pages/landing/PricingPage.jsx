...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Any person with login access to HIRIS counts as a seat — regardless of their role (CHRO, Hiring Assistant, Department Leader, etc.).',
  },
  {
...
export default function PricingPage() {
  return (
    <div style={{ fontFamily: 'var(--font-body)', background: 'var(--surface)' }}>
      <Navbar />

      {/* ── Header ── */}
      <section style={{ paddingTop: 120, paddingBottom: 72, background: 'var(--bg)', borderBottom: '1px solid var(--border)', textAlign: 'center' }}>
              ...
              <div key={plan.name} style={{
                ...
                <div style={{ padding: '32px 28px' }}>
                  <div style={{ marginBottom: 24 }}>
                    ...
                    <p style={{ fontSize: 13, color: 'var(--text-secondary)', lineHeight: 1.6 }}>{plan.desc}</p>
                  </div>

...
export default function ProfessorInterviewRoom() {
  ...
  return (
    <div className="bg-[var(--bg)] text-[var(--text-primary)] min-h-screen flex flex-col font-sans">
      ...
      <main className="flex-1 w-full max-w-[1200px] mx-auto p-8 flex flex-col">
        ...
        {phase === 'standby' && (
          <div className="flex-1 flex flex-col items-center justify-center animate-[fadeIn_0.3s_ease-out]">
             <div className="bg-[var(--surface)] border border-[var(--border)] shadow-sm rounded-2xl p-10 max-w-lg w-full text-center">
                ...
                <h1 className="text-2xl font-bold text-[var(--text-primary)] mb-2 tracking-tight">Interview Room</h1>
                <p className="text-[var(--text-muted)] text-[13px] mb-8">
                  You are about to start the interview for <strong className="text-[var(--text-primary)]">Dr. Ananya Roy</strong>.<br/>
                ...
                <button onClick={() => navigate('/')} className="mt-4 text-[var(--text-muted)] text-[12px] font-semibold hover:text-[#024e56] transition underline">
                  Return to Dashboard
                </button>
             </div>
          </div>
        ...
        {phase === 'active' && (
          <div className="flex-1 flex flex-col animate-[fadeIn_0.3s_ease-out]">
            {/* Header info */}
            <div className="flex items-center justify-between bg-[var(--surface)] border border-[var(--border)] rounded-xl px-6 py-4 shadow-sm mb-6">
              <div className="flex items-center gap-4">
                <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-red-50 text-red-500 font-bold">
                  <span className="w-2.5 h-2.5 rounded-full bg-red-500 animate-pulse"></span>
                </div>
                <div>
                  <h2 className="text-[var(--text-primary)] text-[15px] font-bold tracking-tight">Interview in Progress</h2>
            ...
            <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Left Col: Notes */}
              <div className="md:col-span-2 bg-[var(--surface)] rounded-xl border border-[var(--border)] shadow-sm flex flex-col overflow-hidden">
              ...
              <div className="bg-[var(--surface)] rounded-xl border border-[var(--border)] shadow-sm flex flex-col overflow-hidden">
                <div className="px-5 py-4 border-b border-[var(--border)] bg-[var(--bg)] flex justify-between items-center">
                  <h3 className="text-[13px] font-bold text-[var(--text-primary)] flex items-center gap-2">
                ...
                <div className="p-0 overflow-y-auto custom-scrollbar flex-1">
                  <div className="divide-y divide-[#F1F5F9]">
                    {evaluationTraits.map(trait => (
                      <div key={trait} className="p-5 hover:bg-[var(--bg)] transition">
                        ...
                        <textarea 
                          ...
                          className="w-full bg-[var(--surface)] border border-[#CBD5E1] text-[#334155] text-[13px] p-3 rounded outline-none focus:border-[#024e56] focus:ring-1 focus:ring-[#024e56] shadow-sm transition resize-y min-h-[60px]"
                        ></textarea>
                      </div>
                    ))}
                  </div>
        ...
        {phase === 'review' && (
          <div className="flex-1 flex flex-col items-center justify-center py-10 animate-[fadeIn_0.4s_ease-out]">
            <div className="w-full max-w-3xl bg-[var(--surface)] rounded-2xl border border-[var(--border)] shadow-xl overflow-hidden relative">
              {/* HIRIS Watermark */}
              ...
              <div className="relative z-10">
                <div className="px-8 py-6 border-b border-[var(--border)] flex items-center justify-between">
                  <div>
                    <h2 className="text-xl font-bold text-[var(--text-primary)] tracking-tight">Your Final Evaluation</h2>
                ...
                <div className="p-8 space-y-6 bg-[var(--bg)]">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 relative">
                    {Object.keys(manualScores).map(metric => (
                      <div key={metric} className="flex flex-col gap-2">
                        ...
                        <select 
                          className="bg-[var(--surface)] border border-[#CBD5E1] text-[var(--text-primary)] text-[13px] font-semibold px-4 py-2.5 rounded-lg outline-none focus:border-[#024e56] focus:ring-2 focus:ring-[#024e56]/10 shadow-sm transition"
                  ...
                  <div className="mt-8 border-t border-[var(--border)] pt-6">
                    ...
                    <textarea 
                      ...
                      className="w-full bg-[var(--surface)] border border-[#CBD5E1] text-[#334155] text-[13px] p-4 rounded-lg outline-none focus:border-[#024e56] focus:ring-2 focus:ring-[#024e56]/10 shadow-sm transition min-h-[120px] resize-y"
                    ></textarea>
                  </div>
                </div>

                <div className="px-8 py-6 bg-[var(--surface)] border-t border-[var(--border)] flex items-center justify-end gap-4">

        ...
        <form className="space-y-8" onSubmit={handleSubmit}>
          ...
          <section className="rounded-xl bg-[var(--surface)] p-5 shadow-[0_1px_3px_rgba(0,0,0,0.06)] ring-1 ring-[#28666E]/20 transition-all duration-150 sm:p-5">
            <div className="mb-6 flex items-center gap-3">
              ...
              <h3 className="text-xl font-bold text-[var(--text-primary)]">1. Personal Information</h3>
            </div>
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
              <div className="space-y-2">
                <label className="text-sm font-semibold text-[#334155]">Full Name</label>
                <input required type="text" value={formData.name} onChange={e => handleInputChange('name', e.target.value)} className="w-full rounded-lg border-[var(--border)] bg-[var(--bg)] p-3 text-[var(--text-primary)] focus:border-[#28666E] focus:ring-[#28666E]/20 transition-all duration-150" placeholder="John Doe" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-semibold text-[#334155]">Email Address</label>
                <input required type="email" value={formData.email} onChange={e => handleInputChange('email', e.target.value)} className="w-full rounded-lg border-[var(--border)] bg-[var(--bg)] p-3 text-[var(--text-primary)] focus:border-[#28666E] focus:ring-[#28666E]/20 transition-all duration-150" placeholder="john@example.com" />
              </div>
            </div>
          </section>
          ...
          <section className="rounded-xl bg-[var(--surface)] p-5 shadow-[0_1px_3px_rgba(0,0,0,0.06)] ring-1 ring-[#28666E]/20 transition-all duration-150 sm:p-5">
            <div className="mb-6 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl font-bold text-[var(--text-primary)]">2. Academic Background</h3>
              </div>
            ...
            <div className="space-y-8">
              {formData.degrees.map((degree, index) => (
                <div key={degree.id} className="degree-entry grid grid-cols-1 gap-5 sm:grid-cols-2 pb-6 border-b border-[var(--border)] last:border-0 last:pb-0 pt-0 mt-0 first:pt-0 border-t-0 p-[unset] border-slate-100">
          ...
          <section className="rounded-xl bg-[var(--surface)] p-5 shadow-[0_1px_3px_rgba(0,0,0,0.06)] ring-1 ring-[#28666E]/20 transition-all duration-150 sm:p-5">
            <div className="mb-6 flex items-center gap-3">
              ...
              <h3 className="text-xl font-bold text-[var(--text-primary)]">3. Documents</h3>
            </div>
          ...
          <section className="rounded-xl bg-[var(--surface)] p-5 shadow-[0_1px_3px_rgba(0,0,0,0.06)] ring-1 ring-[#28666E]/20 transition-all duration-150 sm:p-5">
            <div className="mb-6 flex items-center gap-3">
              ...
              <h3 className="text-xl font-bold text-[var(--text-primary)]">4. Professional Links</h3>
            </div>
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
              <div className="space-y-2">
          ...
          <section className="rounded-xl bg-[var(--surface)] p-5 shadow-[0_1px_3px_rgba(0,0,0,0.06)] ring-1 ring-[#28666E]/20 transition-all duration-150 sm:p-5">
            <div className="mb-6 flex items-center gap-3">
              ...
              <h3 className="text-xl font-bold text-[var(--text-primary)]">5. Additional Questions</h3>
            </div>
            <div className="space-y-6">
              <div className="space-y-2">
          ...
          <div className="flex flex-col items-center justify-between gap-4 rounded-xl border border-[#28666E]/20 bg-[#28666E]/5 p-5 sm:flex-row">
            <div className="flex items-start gap-3">
              <input type="checkbox" id="terms" checked={formData.termsAccepted} onChange={e => handleInputChange('termsAccepted', e.target.checked)} className="mt-1 rounded border-[#CBD5E1] text-[#28666E] focus:ring-[#28666E]/20 transition-all duration-150" />

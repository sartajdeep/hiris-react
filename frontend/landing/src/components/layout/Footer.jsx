  ...
  return (
    <footer style={{ background: 'var(--navy)', color: 'white', paddingTop: 72, paddingBottom: 40 }}>
      <div className="container">
        {/* Top: logo + links */}
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: 48, paddingBottom: 56, borderBottom: '1px solid rgba(255,255,255,0.1)' }}>
          {/* Brand */}
          <div>
        ...
        <div style={{ paddingTop: 28, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: 20 }}>
            {['Privacy Policy', 'Terms of Service', 'Cookie Policy'].map(t => (
              <a key={t} href="#" style={{ fontSize: 12, color: 'rgba(255,255,255,0.3)', transition: 'color 0.15s' }}

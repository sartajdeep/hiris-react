        ...
        <div style={{ maxWidth: 740, margin: '0 auto', padding: '0 24px' }}>
          ...
          <div style={{ marginBottom: 36 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
              ...
              <span style={{ fontSize: 12, color: 'var(--slate-400)', fontWeight: 600 }}>Step {step} of 4</span>
            </div>
          ...
          {/* ── Step 4: Confirmation ── */}
          {step === 4 && (
            <div style={{ background: 'white', border: '1px solid var(--border)', borderRadius: 16, padding: '40px 36px', textAlign: 'center', boxShadow: 'var(--shadow-md)' }}>
              <div style={{ width: 60, height: 60, borderRadius: '50%', background: 'var(--teal-10)', border: '2px solid rgba(40,102,110,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 20px' }}>
              ...
              <p style={{ color: 'var(--slate-600)', fontSize: 14, marginBottom: 32, lineHeight: 1.7 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 32, textAlign: 'left' }}>
                {invites.filter(i => i.email.trim()).map((inv, i) => {
                  ...
                  const portal = inv.roleKey === 'chro' ? 'CHRO Portal — localhost:5175' : inv.roleKey === 'hiring-assistant' ? 'Hiring Assistant — localhost:5173' : 'Faculty Portal — localhost:5174'
                  return (
                    <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '12px 16px', border: '1px solid var(--border)', borderRadius: 10, background: 'var(--slate-50)' }}>
                      ...
                      <div style={{ flex: 1 }}>
                        <div style={{ fontSize: 13, fontWeight: 700, color: 'var(--navy)' }}>{inv.name || inv.email}</div>
                        <div style={{ fontSize: 11, color: 'var(--slate-500)' }}>{inv.email} · {role?.label}</div>
                      </div>
              ...
              <div style={{ display: 'flex', gap: 10, justifyContent: 'center', flexWrap: 'wrap' }}>
                <a href="http://localhost:5175/login" className="btn-primary">Open CHRO Portal</a>
                <a href="http://localhost:5173/login" className="btn-secondary">Hiring Assistant Portal</a>
                <a href="http://localhost:5174/login" className="btn-secondary">Faculty Portal</a>
              </div>
            </div>
          )}
        </div>

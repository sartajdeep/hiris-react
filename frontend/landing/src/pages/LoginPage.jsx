          ...
          <div style={{ width: '100%', maxWidth: 420, padding: '0 24px' }}>
            ...
            <div style={{ marginTop: 20, padding: '14px 16px', background: 'white', border: '1px solid var(--border)', borderRadius: 10, fontSize: 12, color: 'var(--slate-500)' }}>
              ...
              {Object.entries(DEMO_USERS).map(([email, cfg]) => (
                <button key={email} onClick={() => setEmail(email)} style={{ display: 'block', width: '100%', textAlign: 'left', padding: '5px 0', background: 'none', border: 'none', cursor: 'pointer', fontSize: 12, color: 'var(--slate-500)', transition: 'color 0.1s' }}

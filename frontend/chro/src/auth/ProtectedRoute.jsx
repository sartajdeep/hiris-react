...
const PORTAL_URLS = {
  chro: 'http://localhost:5175',
  'hiring-assistant': 'http://localhost:5173',
  professor: 'http://localhost:5174',
}
...
export default function ProtectedRoute({ children, requiredRole }) {
  ...
  if (requiredRole && user.role !== requiredRole) {
    const portalUrl = PORTAL_URLS[user.role] || user.portalUrl || 'http://localhost:5176/login'
